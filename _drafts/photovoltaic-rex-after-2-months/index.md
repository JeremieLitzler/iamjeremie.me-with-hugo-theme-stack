---
title: "Photovoltaïc: my experience after 2 months"
description: "At the end of March 2022, we activated our photovoltaic installation. Let’s look at the data at the end of May 2022."
date: 2022-06-01
categories:
  - Energy
tags:
...
Seven year ago, we bought our house, on a property with an acre of rocky and staircased-land.

It was not very welcoming to plant anything (we have tried the ["_No Dig_" method from Charles Dowding](https://www.youtube.com/c/CharlesDowding1nodig) and followed [the tips of Damien Dekarz](https://www.youtube.com/c/permacultureetc)...). However, to produce electricity, it seemed possible even if the sun exposure wasn't ideal.

<!-- more -->

## The serie of articles

<!-- - [Photovoltaïc: my experience after 9 months (part 1)](../photovoltaic-rex-after-9-months-part1/index.md)
- [Photovoltaïc: my experience after 9 months (part 2)](../photovoltaic-rex-after-9-months-part2/index.md)
- [Photovoltaïc: my experience after a year](../photovoltaic-rex-after-a-year/index.md) -->

In France, we have special tariffs from the power company that allow to pay less during some hours of the night (10PM to 6PM usually). We use such a tariff.

In addition to that we have insulated our 200-liter water heater, with 10 centimeters of raw sheep wool, the first winter because it is installed in the garage and the temperature can go as low as 8°C...

I know it is not ideal, but we don't have any other option in our small house.

With that insulation, we went from 12-13kWh to heat the water down to 8-10kWh on a similar day.

## Why a photovoltaic installation

### Our household consumption

I'm monitoring our electric usage closely. In 2016, I made an estimation, listing all the electric appliances, small to great, to understand our household profile. It is the first toward a better efficiency and helps to know where we can act.

The estimation came back with 2900 kWh sur 1 an. You can have a look at the details in [this spreadsheet](https://docs.google.com/spreadsheets/d/1-1A2I04MqVy3-zxMwQJ7Zy83OP200ruxGRUNXsHlNbQ/edit?usp=sharing) anad make a copy for yourself, if you want to profile your household usage.

In my household, we saw that the water heater was responsible of 30% of the total consumption.

_NB:_ The spreadsheet doesn't include a oven, dishwasher and forced ventilation as they were installed in 2018.

Sincce day 1, I perform of consumption measurement with:

- a daily measurement the first few years,
- then a weekly measurement thanks to the smart meter _Linky_,
- and for the water heater, I installed an old electronic meter in Novermber 2019 to count accurately the electric consumption of the appliance.

Since 2014, here are the data:

- our overall consumption month by month:
...
This confirmed the estimation of 30% for the water heater.

### Estimating the sun exposure of our property

I made the simulation using the ["PHOTOVOLTAIC GEOGRAPHICAL INFORMATION SYSTEM"](https://re.jrc.ec.europa.eu/pvg_tools/fr/#PVP) tool on our house roof top (the lowest point on our property) and at the highest point of the property (the area where we had the most sun and an area to install the photovoltaïc modules).

| Month    | Hours of sun (house rooftop)  | Hours (highest point on property) | Delta    |
| -------- | ----------------------------- | --------------------------------- | -------- |
...
As you see, there is no dicussion!

If we wanted to produce electricity from the sun, the higest point on the property was the place to use, even if the sun exposure wasn't ideal since we are on the side of a 300-meters hill facing West...

## Why did we installed the photovoltaïc modules only in 2022?

My prerequisites for the project were:

- a budget of 2000 euros thanks to recycling old PV modules.
- a requirement to self-consumme the production as much as possible since it wasn't possible to sale the unused production to the power company.
- become profitable before the sensitive components of the installation (mainly the inverter) were not covered by the warranty anymore.

I read a lot on the topic since 2014 and I performed many quotes on the various websites saling the PV solutions. However, I never went ahead because of:

- the lack of solution to match my objectives,
- the cost of the components,
- the fact that small setups weren't very commun (companies saling 3kWc at around 7000 to 15000 euros).
